<?php 
    ...
    $note_icons = ['fa-solid  fa-user','fa-solid  fa-hotel','fa-solid  fa-comments-dollar','fa-solid fa-globe','fa-solid fa-globe','fa-solid fa-money-bill','fa-solid  fa-dollar'];
    $heading = ['Add User','Hotel',' Currency','Reservation Source','Reservation Status','Payment Method','Advance Currency'];
    $nlinks = ['add_user.php','hotel.php','currency.php','source.php','status.php','payment_method.php','advance_currency.php']
?>
    <div class="flex">  
