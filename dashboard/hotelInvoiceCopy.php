                                                ...
                                                <table class="w-full">
                                                    ...
                                                    <tbody class="divide-y divide-cyan-950">
                                                        <?php if ($bookingComHotelCollects > 0) {
                                                            $commissionableAmountBooking = $bookingComHotelCollects * 0.20; // 20% commission
                                                        ?>
                                                            <tr class="border border-cyan-950">
                                                                ...
                                                                <td class="px-1 py-1.5 text-xs font-medium text-black">20%</td>
                                                        ...
                                                        <?php if ($expediaHotelCollects > 0) {
                                                            $commissionableAmountHotel = $expediaHotelCollects * 0.20; // 20% commission
                                                        ?>
                                                            <tr class="border border-cyan-950">
                                                                <td class="px-1 py-1.5 text-xs font-medium text-black"><?php echo $i++ ?></td>
                                                        ...
                                                        <?php if ($expediaExpedaCollects > 0) {
                                                            $commissionableAmountExpedia = $expediaExpedaCollects * 0.20; // 20% commission
                                                            $afterCommissionableAmountExpedia = $expediaExpedaCollects * 0.80;
